    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-serif font-bold text-white">DEKA</h3>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-serif font-bold text-white mb-6">Navigation</h4>
          ...
          {/* Location */}
          <div>
            <h4 className="font-serif font-bold text-white mb-6">Zones</h4>
        ...
        <div className="border-t border-gray-700 pt-12">
          <h4 className="font-serif font-bold text-white mb-6 text-sm uppercase tracking-widest">
            Expertise
          </h4>
      ...
      <div className="border-t border-gray-700 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            ...
            <a href="mailto:contact@deka-partners.com" className="text-gray-500 hover:text-[#d4af37] transition text-sm">
              Contact
            </a>
          </div>
        </div>
